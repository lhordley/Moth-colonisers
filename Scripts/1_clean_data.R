...
# Load data
cdata <- read.csv("Coloniser data/moth_coloniser_data_spp.csv", header=TRUE) # Categories based on Parsons 2003, 2010, 2020
...
write.csv(cdata_final2, file="Coloniser data/moth_coloniser_nspp_consensus.csv", row.names=FALSE)
